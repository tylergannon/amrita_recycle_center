...
describe TimeEntriesController do
  ...
  let(:valid_attributes) { { "start_time" => "2014-01-09 09:50:51", "end_time" =>  "2014-01-09 12:50:51"} }
  ...
  describe "GET show" do
    it "assigns the requested time_entry as @time_entry" do
      time_entry = create(:time_entry)
      get :show, {:id => time_entry.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested time_entry as @time_entry" do
      time_entry = create(:time_entry)
      get :edit, {:id => time_entry.to_param}, valid_session
      assigns(:time_entry).should eq(time_entry)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved time_entry as @time_entry" do
        ...
        post :create, {:time_entry => { "start_time" => "invalid value" }}, valid_session
        assigns(:time_entry).should be_a_new(TimeEntry)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested time_entry" do
        ...
        TimeEntry.any_instance.should_receive(:update).with({ "start_time" => "2014-01-09 09:50:51" })
        put :update, {:id => time_entry.to_param, :time_entry => { "start_time" => "2014-01-09 09:50:51" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the time_entry as @time_entry" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TimeEntry.any_instance.stub(:save).and_return(false)
        put :update, {:id => time_entry.to_param, :time_entry => { "start_time" => "invalid value" }}, valid_session
        assigns(:time_entry).should eq(time_entry)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested time_entry" do
      time_entry = create(:time_entry)
      expect {
        delete :destroy, {:id => time_entry.to_param}, valid_session
      }.to change(TimeEntry, :count).by(-1)
    end
